...
from main.views import show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, proxy_image
from main.views import edit_news, delete_news
from main.views import add_news_entry_ajax, create_news_flutter
